...
void main()
{
	...
	cout << "Введите  добавляемого значение: "; cin >> value;
	...
	cout << "Введите индекс удаленного элемента: "; cin >> index;
...
int* push_back(int arr[], int& n, const int value)
{
	...
	//3)Удаляем исходный массив памяти:
	delete[] arr;
